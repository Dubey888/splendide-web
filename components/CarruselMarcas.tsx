  ...
  return (
    <Swiper
      ...
      breakpoints={{
        ...
        1280: { slidesPerView: 7.5, spaceBetween: 24 },
        1920: { slidesPerView: 9.5, spaceBetween: 24 },
      }}
        ...
        <SwiperSlide key={index}>
          <Link href={marca.url} className="block group">
            <div className="aspect-[4/5] bg-gray-100 rounded-xl overflow-hidden relative shadow-sm mb-3">
              <img src={marca.imagen} alt={marca.nombre} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
