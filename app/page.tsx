  ...
  return (
    <div className="min-h-screen bg-[#FCF6F6] text-[#1A1A1A]">
      ...
      <main className="w-full">
        {/* Frase Inspiracional con Fuente Serif */}
        ...
        {/* Sección Marcas */}
        <section className="bg-[#DFB2C0]/10 w-full py-16 mb-16">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
            {[
                { title: "Skincare", url: "/categorias/skincare.jpg", link: "/colecciones/skincare", subtitle: "Cuidado Facial" },
                { title: "Esenciales", url: "/categorias/esenciales.jpg", link: "/colecciones/esenciales", subtitle: "Ver Productos" }
            ].map((cat) => (
                <div key={cat.title} className="group flex flex-col">
                    <Link href={cat.link} className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-sm block">
                        ...
                        <h3 className="absolute inset-0 flex items-center justify-center text-white font-serif text-4xl drop-shadow-md">
                            {cat.title}
                        </h3>
                    </Link>
                    <Link href={cat.link} className="mt-6 text-[#1A1A1A] text-center font-serif text-lg tracking-wide hover:underline underline-offset-8">
                        {cat.subtitle}
                    </Link>
                </div>
            ))}
          ...
          <section className="mb-24">
            <h3 className="text-3xl font-serif text-[#1A1A1A] italic mb-12">Esenciales</h3>
